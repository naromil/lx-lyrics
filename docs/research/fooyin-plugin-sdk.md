...
- API stability: pre-1.0 and evolving; the tree was compiled against v0.12.1 headers and is load-verified against the installed Fooyin 0.12.6 (2026-09-16). Build against the same fooyin release you target. Fooyin is GPLv3 — plan plugin licensing accordingly.
