...
public:
    using LyricProvider =
        std::function<void(const Fooyin::Track&, QString& lrc, QString& tlrc, QString& rlrc, QString& lxlrc)>;
...
private:
    ...
    void currentLyrics(const Fooyin::Track& track, QString& lrc, QString& tlrc, QString& rlrc,
                       QString& lxlrc) const;
    [[nodiscard]] QVariantMap setInfoFields(const Fooyin::Track& track, bool isPlay, qint64 playedTime,
