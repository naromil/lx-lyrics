...
const QString kThreeLineLrc = QStringLiteral(
    "[00:00.50]First\n"
    "[00:02.00]Second\n"
    "[00:03.50]Third");
...
const QString kFourLineLrc = QStringLiteral(
    "[00:00.500]First\n"
    "[00:02.00]Second\n"
    "[00:05.00]Third\n"
    "[00:06.00]Fourth");
...
const QString kLeadInLrc = QStringLiteral(
    "[00:00.500]First\n"
    "[00:02.00]Second\n"
    "[00:03.50]Third");
const QString kOffsetLrc = QStringLiteral("[offset:500]\n[00:01.00]X");
const QString kRateLrc = QStringLiteral(
    "[00:00.500]A\n"
    "[00:02.00]B\n"
    "[00:03.50]C");
